...
<td><a href="update_process_u.php?user_id=<?php echo $row["user_id"]; ?>">Update</a></td>
</tr>
<?php $count++; } ?>
</table>
</form>
...
<td><a href="update_process_c.php?car_id=<?php echo $row["car_id"]; ?>">Update</a></td>
</tr>
<?php $count++; } ?>
</table>
</form>
...
<td>$<?php echo $row["price"]; ?></td>
<td><a href="update_process_t.php?trip_id=<?php echo $row["trip_id"]; ?>">Update</a></td>
</tr>
<?php $count++; } ?>
</table>
</form>
...
<td>$<?php echo $row["price"]; ?></td>
<td><?php echo $row["img"]; ?></td>
<td><a href="update_process_f.php?flower_id=<?php echo $row["flower_id"]; ?>">Update</a></td>
</tr>
<?php $count++; } ?>
</table>
</form>
...
<td><a href="update_process_o.php?order_id=<?php echo $row["order_id"]; ?>">Update</a></td>
</tr>
<?php $count++; } ?>
</table>
</form>
